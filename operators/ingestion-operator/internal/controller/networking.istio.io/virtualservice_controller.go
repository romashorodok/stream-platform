...
//+kubebuilder:rbac:groups=networking.istio.io.romashorodok.github.io,resources=virtualservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=networking.istio.io.romashorodok.github.io,resources=virtualservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=networking.istio.io.romashorodok.github.io,resources=virtualservices/finalizers,verbs=update
...
func (r *VirtualServiceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("catch istio virtual network", "istio virtual service", req)
